...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20231122180005_ColaboradorToVeiculo")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(140), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 6,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(173), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 5,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(175), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(177), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 3,
                            ColaboradorId = 7,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(178), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(179), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2023, 11, 22, 15, 0, 5, 123, DateTimeKind.Unspecified).AddTicks(181), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorVeiculo", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("DataDeVinculo")
                        .HasColumnType("datetimeoffset");
